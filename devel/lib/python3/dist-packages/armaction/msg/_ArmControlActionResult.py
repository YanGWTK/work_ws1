...
"""autogenerated by genpy from armaction/ArmControlActionResult.msg. Do not edit."""
import codecs
import sys
...
class ArmControlActionResult(genpy.Message):
  ...
  _type = "armaction/ArmControlActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','armaction/ArmControlResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = armaction.msg.ArmControlResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = armaction.msg.ArmControlResult()
