...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.teams = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RobotListenerConfig::AbstractParamDescriptionConstPtr(new RobotListenerConfig::ParamDescription<int>("teams", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'convoyl', 'type': 'int', 'value': 0, 'srcline': 13, 'srcfile': '/home/jetson/yahboomcar_ws/src/yahboomcar_multi/cfg/RobotListener.cfg', 'description': 'A small data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'vertical', 'type': 'int', 'value': 1, 'srcline': 14, 'srcfile': '/home/jetson/yahboomcar_ws/src/yahboomcar_multi/cfg/RobotListener.cfg', 'description': 'A medium data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'horizonta', 'type': 'int', 'value': 2, 'srcline': 15, 'srcfile': '/home/jetson/yahboomcar_ws/src/yahboomcar_multi/cfg/RobotListener.cfg', 'description': 'A large data', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &RobotListenerConfig::teams)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RobotListenerConfig::AbstractParamDescriptionConstPtr(new RobotListenerConfig::ParamDescription<int>("robot_model", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'omni', 'type': 'int', 'value': 0, 'srcline': 19, 'srcfile': '/home/jetson/yahboomcar_ws/src/yahboomcar_multi/cfg/RobotListener.cfg', 'description': 'A medium data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'diff', 'type': 'int', 'value': 1, 'srcline': 20, 'srcfile': '/home/jetson/yahboomcar_ws/src/yahboomcar_multi/cfg/RobotListener.cfg', 'description': 'A large data', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &RobotListenerConfig::robot_model)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(RobotListenerConfig::AbstractParamDescriptionConstPtr(new RobotListenerConfig::ParamDescription<int>("robot_model", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'omni', 'type': 'int', 'value': 0, 'srcline': 19, 'srcfile': '/home/jetson/yahboomcar_ws/src/yahboomcar_multi/cfg/RobotListener.cfg', 'description': 'A medium data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'diff', 'type': 'int', 'value': 1, 'srcline': 20, 'srcfile': '/home/jetson/yahboomcar_ws/src/yahboomcar_multi/cfg/RobotListener.cfg', 'description': 'A large data', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &RobotListenerConfig::robot_model)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.navigate = 0;
